-- Function: portal.reg_cont_event_notifications_v2(bigint, boolean)

-- DROP FUNCTION portal.reg_cont_event_notifications_v2(bigint, boolean);

CREATE OR REPLACE FUNCTION portal.reg_cont_event_notifications_v2(
...
loop
	...
	BEGIN
		PERFORM portal.reg_subscr_cont_event_notification_v2(subscrs.subscriber_id,subscrs.cont_event_id);
	EXCEPTION
		when OTHERS THEN 
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION portal.reg_cont_event_notifications_v2(bigint, boolean)
  OWNER TO dbuser1;
GRANT EXECUTE ON FUNCTION portal.reg_cont_event_notifications_v2(bigint, boolean) TO dbuser1;
GRANT EXECUTE ON FUNCTION portal.reg_cont_event_notifications_v2(bigint, boolean) TO public;
GRANT EXECUTE ON FUNCTION portal.reg_cont_event_notifications_v2(bigint, boolean) TO portal_role;
