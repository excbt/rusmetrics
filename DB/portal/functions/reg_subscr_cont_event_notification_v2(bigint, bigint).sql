-- Function: portal.reg_subscr_cont_event_notification_v2(bigint, bigint)

-- DROP FUNCTION portal.reg_subscr_cont_event_notification_v2(bigint, bigint);

CREATE OR REPLACE FUNCTION portal.reg_subscr_cont_event_notification_v2(
...
END;$BODY$
  ...
  COST 100;
ALTER FUNCTION portal.reg_subscr_cont_event_notification_v2(bigint, bigint)
  OWNER TO dbuser1;
GRANT EXECUTE ON FUNCTION portal.reg_subscr_cont_event_notification_v2(bigint, bigint) TO dbuser1;
GRANT EXECUTE ON FUNCTION portal.reg_subscr_cont_event_notification_v2(bigint, bigint) TO public;
GRANT EXECUTE ON FUNCTION portal.reg_subscr_cont_event_notification_v2(bigint, bigint) TO portal_role;
