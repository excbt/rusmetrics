...
/*jshint -W041: false*/
/*global angular, $, moment, alert, document, window*/
(function () {
    'use strict';

    //var app = angular.module('portalNMC');
    angular.module('portalNMC')
        .directive('crudGridObjectsTree', function () {
        return {
            restrict: 'A',
            replace: false,
            scope: {
    ...
    //        },
            controller: ['$scope', '$rootScope', '$attrs', '$cookies', '$compile', '$timeout', 'crudGridDataFactory', 'notificationFactory', '$http', 'objectSvc', 'mainSvc', 'reportSvc', 'indicatorSvc', 'monitorSvc', '$location', '$interval', 'energoPassportSvc', '$q', 'objectsTreeSvc',
                function ($scope, $rootScope, $attrs, $cookies, $compile, $timeout, crudGridDataFactory, notificationFactory, $http, objectSvc, mainSvc, reportSvc, indicatorSvc, monitorSvc, $location, $interval, energoPassportSvc, $q, objectsTreeSvc) {
