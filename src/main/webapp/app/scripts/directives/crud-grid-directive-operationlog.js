...
angular.module('portalNMK').directive('crudGridOperationLog', function () {
    return {
        restrict: 'A',
        replace: false,
        scope: {
        ...
        templateUrl: 'scripts/directives/templates/crud-grid-directive-operationlog-template.html',
