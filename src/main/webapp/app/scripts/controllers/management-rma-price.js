...
app.filter('viewHistory', function () {
...
app.controller('MngmtPriceCtrl', ['$rootScope', '$scope', '$http', 'mainSvc', 'notificationFactory', '$log', function ($rootScope, $scope, $http, mainSvc, notificationFactory, $log) {
