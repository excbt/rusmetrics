...
app.controller('ObjectGroupsCtrl', ['$rootScope', '$scope', 'crudGridDataFactory', 'notificationFactory', 'objectSvc', 'mainSvc', function ($rootScope, $scope, crudGridDataFactory, notificationFactory, objectSvc, mainSvc) {
...
//        {'name': "group 2"}
    ...
    function performObjectArray() {
        var result = [],
            i;
        for (i = 0; i < $scope.selectedObjects.length; i += 1) {
...
//    };
    ...
    $scope.selectAllAvailableEntities = function () {
        var index;
        for (index = 0; index < $scope.availableObjects.length; index += 1) {
