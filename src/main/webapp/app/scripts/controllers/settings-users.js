...
app.controller('SettingsUsersCtrl', ['$rootScope', '$scope', '$http', 'notificationFactory', 'crudGridDataFactory', 'mainSvc', function ($rootScope, $scope, $http, notificationFactory, crudGridDataFactory, mainSvc) {
