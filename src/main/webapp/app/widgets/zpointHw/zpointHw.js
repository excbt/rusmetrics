...
angular.module('zpointHwWidget', ['angularWidget', 'chart.js'])
...
//        ];
        ...
        $scope.data.imgPath = "widgets/zpointHw/tint.png";
...
//                console.log(tooltip);
				...
				bodyLines.forEach(function (body, i) {
					...
					var span = '<span class="chartjs-tooltip-key-hw" style="' + style + '"></span>';
