...
console.log('http params: ', httpParams);
        return this.http.get<NoticeWrapperPaged>(url, {params: new HttpParams()}).map((res) => this.prepareNotices(res.objects));        
    }
...
//        noticeWrapper.push();
    ...
    prepareNotice(notice: Notice): NoticeWrapper {
        let noticeWrapper: NoticeWrapper = new NoticeWrapper(notice);
