...
public class SubscrRoleRepositoryTest extends JpaSupportTest {

	
	private static final Logger logger = LoggerFactory
			.getLogger(SubscrRoleRepositoryTest.class);
	...
	public void testSubscrRole() {
		SubscrRole sr = subscrOrgRepository.findOne(728L);
		assertNotNull(sr);
		...
		List<SubscrRole> soList = subscrOrgRepository.selectByOrganizationId(726);
